let srcList = {
    gnewsio : {
        ...
        search : function(keywords = '', lang = '', from = '', to = '') {
            if (keywords === '') {
                ...
                return (
                    'https://gnews.io/api/v4/search?q=' + keywords +
                    '&lang=' + lang +
                    '&from=' + from + 'T' + Date().slice(16,24) + 'Z' +
                    '&to=' + to + 'T' + Date().slice(16,24) + 'Z' +
                    '&token=' + this.token
                );
            }
        }
    ...
    mediastackcom : {
        ...
        search : function(keywords = '', lang = '', from = '', to = '') {
            if (keywords === '') {
                ...
                return (
                    'http://api.mediastack.com/v1/news?access_key=' + this.token +
                    '&sources=' + lang +
                    '&date=' + from +
                    ',' + to +
                    '&keywords=' + keywords
    ...
    //     name : 'NewsApi.org',
    //     code : 'newsapiorg',
    //     token : '46087c9c7eb54feb850ce8515ba8aca4',
    //     topHeadlines : function() {
    //         return 'https://newsapi.org/v2/top-headlines?country=us&apiKey=' + this.token;
    //     },
    //     search : function(keywords = '') {
    //         if (keywords === '') {
    //             return this.topHeadlines();
    //         } else {
    //             return ('https://newsapi.org/v2/everything?q=' + keywords + '&apiKey=' + this.token);
    //         }
    //     }
    // },
};
...
function genrNewsCard(article, src) {
    ...
    return (
        ...
        '<a class="url" target=”_blank” href="' + url + '">' +
        '<p class="title">' + title + '</p>' +
        '</a>' +
        '</div>' +
        '<div class="sub_title my-2">' +
        '<span class="published_at">' + publishedAt + '</span>' +
        '</div>' +
        '<div class="">' +
        '<p class="description mb-3 mb-md-0">' + description + '</p>' +
        '</div>' +
        '</div>' +
        '<div class="col-sm-5">' +
        '<div class="thumb">' +
        ...
        '<div class="read_more">' +
        '<a class="url" target=”_blank” href="' + url + '">' +
        '<p>Read more on <span class="sourse_name">' + source + '</span></p>' +
        '</a>' +
        '</div>' +
...
function genrNewsWidgetLi(article, src) {
    ...
    return (
        ...
        '<div class="read_more">' +
        '<a class="url" target=”_blank” href="' + url + '">' +
        '<p><span class="sourse_name">' + source + '</span></p>' +
        '</a>' +
        '</div>' +
        '<div class="published">' +
        '<span class="published_at">' + publishedAt + '</span>' +
